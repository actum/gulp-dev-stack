...
gulp.task('less', () => {
    ...
    let combined = combiner.obj([
        ...
        rename('style.css'),
        gulp.dest(isDev ? src.css : dist.css),
...
gulp.task('swig', () => {
    let opts = {
        ...
        data: {
            '_dev': isDev,
            '_pages': (() => {
                return glob.sync(`${src.tpl}/*.swig`).map((pathname) => {
...
gulp.task('serve', ['prepare'], () => {
    ...
    if (isDev) {
        ...
        watch(`${src.tpl}/**/*.swig`, ['swig']);
        watch(src.appFiles, ['lint:app']);
